...
test("overlap review documents the Equipment Incidents rules boundary", () => {
  const review = fs.readFileSync(path.join(root, "docs/OVERLAP_REVIEW.md"), "utf8");
  for (const phrase of ["Equipment Incidents I review", "Equipment Incidents II review", "Equipment Incidents III review", "Repair", "Craft", "Pick a Lock", "Disable a Device", "Treat Wounds", "Administer First Aid", "Treat Disease", "Treat Poison", "rc.6.1"]) {
